...
import { suspendSchema } from "@/lib/validation/tenant-lifecycle";
...
export async function POST(
  ...
  try {
    const result = await applySuspension({
      tenantId: id,
      input: parsed.data,
    ...
    console.error("Tenant suspension failed", err instanceof Error ? err.message : err);
